 ...
 * @source https://github.com/An00nymushun/DiscordFreeEmojis/blob/master/DiscordFreeEmojisSplit64px.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
function Init(nonInvasive)
{
    ...
    let channelCacheModule = findModuleByUniqueProperties( [ 'getChannel', 'getDMFromUserId' ], nonInvasive);
